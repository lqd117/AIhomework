...
//		c
		...
		for(int i=0;i<1000;i++){
			...
			System.out.println(myNeuralNetwork.compute_cost(temp.getFirst(), yArray));
			Map<String, MyArray> grads = myNeuralNetwork.L_model_backward(temp.getFirst(), yArray, temp.getSecond());
